...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  */
  ...
  $result = mysql_fetch_assoc($s_result);
	...
	setcookie('complete','complete',time()+60*5);
...
<?php if (isset($_COOKIE['complete'])) { // Show if recordset not empty ?>
<h1>
    <p align="center" style="color:#F00">如果您有朋友想繼續填寫，請稍候五分鐘。</p></h1>
  ...
  <form name="form1" action="<?php echo $editFormAction; ?>" method="POST" id="form1">
    <div id="content">
      <table width="600" height="1452" border="1">
        ...
        <tr>
          <td>如果可以在瀏覽網頁時，對有興趣的圖片、文章......等，即時取得授權，您會在頁面上申請授權嗎？ 
          <span style="color:#F00">*</span></td>
        </tr>
        <tr>
          <td><p>
