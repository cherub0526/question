...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  */
  ...
  $result = mysql_fetch_assoc($s_result);
	if( $macaddress || isset($_SESSION['complete']))
  {
...
<body>
<div id="title">
  <h1 align="center" style="color:#F00">線上授權意見調查表<?php echo $macaddress ?></h1>
</div>
  
<?php if ($totalRows_RecIp > 0 || isset($_SESSION['complete'])) { // Show if recordset not empty ?>
  ...
  <?php } else if (isset($_SESSION['complete']))  { ?>
    <h1>
